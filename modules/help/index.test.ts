      ...
      expect(requests).toStrictEqual([
        {
          ...
          payload: {
            ...
            text: [
              ...
              '\u2022 To end a game, type /poker\\_stop',
              '',
              ...
              '\u2022 To see current year statistics, type /pumpkin\\_stats\\_year',
              '',
              '*Poker Rules:*',
              "The game follows [Texas Hold'em](https://en\\.wikipedia\\.org/wiki/Texas\\_hold\\_%27em) rules\\.",
